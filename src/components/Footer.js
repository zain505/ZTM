                        ...
                        <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                            ...
                            <ul className="text-md">
                                {allServices?.map(service => {
                                    return (
                                        <li className="mb-2">
                                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out" style={{textTransform:"capitalize"}}>{service.data.serviceHeader}</Link>
                                        </li>
                                    )
                                })
                                }
